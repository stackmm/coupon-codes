...
describe Merchant do
  ...
  describe "instance methods" do
    ...
    it "too_many_active_coupons?" do
      expect(@merchant1.too_many_active_coupons?).to eq(false)
      expect(@merchant2.too_many_active_coupons?).to eq(false)
    end

    it "active_coupons" do
      expect(@merchant1.active_coupons).to eq([@coupon_1, @coupon_2, @coupon_3, @coupon_4])
      expect(@merchant2.active_coupons).to eq([@coupon_6, @coupon_8])
    end

    it "inactive_coupons" do
      expect(@merchant1.inactive_coupons).to eq([@coupon_5])
      expect(@merchant2.inactive_coupons).to eq([@coupon_7])
    end
  end
end
