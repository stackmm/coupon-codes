...
@coupon_1 = Coupon.create!(name: "Half Off", code: "HALFOFF", value: 50, discount_type: "percent-off", merchant_id: 1)
@coupon_2 = Coupon.create!(name: "OMG it's FREE!", code: "FULLOFF", value: 100, discount_type: "percent-off", merchant_id: 1)
@coupon_3 = Coupon.create!(name: "10% Off", code: "TENOFF", value: 10, discount_type: "percent-off", merchant_id: 1)
...
@coupon_7 = Coupon.create!(name: "50% Off!", code: "50%OFF", value: 50, discount_type: "percent-off", merchant_id: 2)
